...
public class IPUlaSSOSamlBuilder {

	private IPUlaSSOSamlBuilder() {
	...
	public static String buildSAMLResponse(String issuer, String recipientURL, String audienceURL, String nameId,
			Integer expirationTime, String jksPath, String password, String alias, String keyPassword)
		...
		Assertion assertion = buildAssertion(issuer, recipientURL, nameId, expirationTime, jksPath, password, alias,
				keyPassword, audienceURL);
	...
	public static Assertion buildAssertion(String issuer, String recipientURL, String nameId, Integer expirationTime,
			String jksPath, String password, String alias, String keyPassword, String audienceURL)
			throws KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException,
