...
public class IRUlaSSOSamlBuilder {

	private IRUlaSSOSamlBuilder() {
	...
	public static String buildSAMLResponse(List<SamlAttribute> attributes, String issuer, String recipientURL,
			String audienceURL, String nameId, Integer expirationTime, Integer authnStatementExpirationTime,
			String jksPath, String password, String alias, String keyPassword)
	...
	public static Assertion buildAssertion(List<SamlAttribute> attributes, String issuer, String recipientURL,
		...
		assertion.setSubject(buildSubject(nameId, recipientURL, expirationTime, issuer, audienceURL));
