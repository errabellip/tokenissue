...
public class SummitviewSamlBuilder {
	
	private SummitviewSamlBuilder(){
	...
	public static String buildSAMLResponse(List<SamlAttribute> attributes, String issuer, String recipientURL, String audienceURL, String nameId, Integer expirationTime, Integer authnStatementExpirationTime, String jksPath, String password, String alias, String keyPassword) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, SecurityException, IOException, TransformerException, MarshallingException, SignatureException {
		...
		Signature signature = buildSignature(jksPath, password, alias, keyPassword);
	...
	private static Subject buildSubject(String subjectNameId, String recipient, Integer expirationTime, DateTime now) {
		...
		nameID.setFormat("urn:oasis:names:tc:SAML:2.0:nameid-format:custom");
