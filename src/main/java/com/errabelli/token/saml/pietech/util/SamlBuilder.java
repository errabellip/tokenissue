...
public class SamlBuilder {
	...
	public static String buildSAMLResponse(List<SamlAttribute> attributes, String issuer, String recipientURL, String nameId, Integer expirationTime, String jksPath, String password, String alias) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, SecurityException, IOException, TransformerException, MarshallingException, SignatureException  {
		...
		response.getAssertions().add(buildAssertion(attributes, issuer, recipientURL, nameId, expirationTime));
	...
	public static Assertion buildAssertion(List<SamlAttribute> attributes, String issuer, String recipientURL, String nameId, Integer expirationTime) {
	...
	private static Signature buildSignature(String jksPath, String password, String alias) throws SecurityException, KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, IOException {
	...
	private static Credential getSigningCredential(String jksPath, String password, String alias) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableEntryException {
